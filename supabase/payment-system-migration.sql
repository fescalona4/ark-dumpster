...
-- Payment webhook events table (enhanced from previous version)
...
-- Remove old Square-specific columns from orders table (optional cleanup)
-- These are comments because they may be referenced elsewhere
-- ALTER TABLE orders DROP COLUMN IF EXISTS square_invoice_id;
-- ALTER TABLE orders DROP COLUMN IF EXISTS square_customer_id;
-- ALTER TABLE orders DROP COLUMN IF EXISTS square_payment_status;
-- ALTER TABLE orders DROP COLUMN IF EXISTS payment_link;
-- ALTER TABLE orders DROP COLUMN IF EXISTS invoice_sent_at;
-- ALTER TABLE orders DROP COLUMN IF EXISTS invoice_viewed_at;
-- ALTER TABLE orders DROP COLUMN IF EXISTS invoice_paid_at;
-- ALTER TABLE orders DROP COLUMN IF EXISTS square_invoice_amount;
-- ALTER TABLE orders DROP COLUMN IF EXISTS square_paid_amount;