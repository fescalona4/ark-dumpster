            ...
            <div className="mx-auto px-6 md:px-10 mt-8">
              <div className="flex flex-col gap-8">
                <div className="flex-1 mt-2">
                  ...
                  <h1 className="text-5xl md:text-4xl pt-2 flex items-center">
              ...
              we make waste disposal simple so you can focus on what matters most. */}
                  ...
                  <div className="w-fit py-8">
                    <Link
                      href="/#contact"
                      className="rounded-full border border-solid transition-colors flex items-center justify-center bg-white/10 backdrop-blur-md border-white/30 text-white hover:bg-neutral-600/70 text-md h-12 px-6"
                    >
                      Get in touch
                    </Link>
                  </div>
