...
export default function AboutSection() {
    return (
        <div className="flex items-center justify-center px-10 md:px-20 mt-8 mb-24">
            <div className="max-w-screen-xl flex flex-col md:flex-row gap-16">
                ...
                <div className="flex-3">
                    <p className="text-2xl bold leading-relaxed pr-10 pt-2">
